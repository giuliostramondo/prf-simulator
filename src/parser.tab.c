...
{
      19,     0,    -1,    19,    20,    -1,    -1,    26,    -1,    27,
      -1,    23,    -1,    21,    -1,     1,    -1,    22,    -1,    28,
      -1,    29,    -1,    14,    13,    11,    -1,     3,     9,    24,
      10,    11,    -1,    24,    12,    25,    -1,    25,    -1,     4,
      -1,     5,    -1,    16,     3,     4,    11,    -1,    16,     3,
       3,    11,    -1,    15,     3,    11,    -1,    30,    12,     5,
      11,    -1,    30,    11,    -1,    30,    12,    31,    -1,    31,
      -1,    14,     7,     4,     8,     7,     4,     8,    -1
};
...
{
       0,    99,    99,    99,   105,   106,   107,   108,   109,   119,
     120,   121,   123,   135,   210,   221,   230,   236,   243,   261,
     279,   318,   327,   361,   366,   372
};
#endif
...
{
  "$end", "error", "$undefined", "IDENTIFIER", "NUMBER", "ACC_TYPE",
  "SCHEME", "LSQUARE", "RSQUARE", "LPAR", "RPAR", "SEMI", "COMMA", "ALL",
  "A", "SHOW", "SET", "CHECK", "$accept", "instructions", "instruction",
  "access_generic", "access_all", "function_call", "arg_list", "argument",
  "set_instruction", "show_instruction", "access_block", "sparse_access",
  "access_list", "access", 0
};
#endif
...
{
       3,     0,     1,     8,     0,     0,     0,     0,     2,     7,
       9,     6,     4,     5,    10,    11,     0,    24,     0,     0,
       0,     0,     0,    22,     0,    16,    17,     0,    15,     0,
      12,    20,     0,     0,     0,     0,    23,     0,     0,     0,
      19,    18,    21,    13,    14,     0,     0,    25
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     1,     8,     9,    10,    11,    27,    28,    12,    13,
      14,    15,    16,    17
};
...
{
     -15,     0,   -15,   -15,     4,    -1,     1,     5,   -15,   -15,
     -15,   -15,   -15,   -15,   -15,   -15,    -2,   -15,    13,    17,
      11,    12,    16,   -15,    -3,   -15,   -15,    -5,   -15,    18,
     -15,   -15,    14,    19,    20,    21,   -15,    22,    13,    25,
     -15,   -15,   -15,   -15,   -15,    23,    26,   -15
};
...
{
       2,     3,    34,     4,    21,    37,    19,    38,    22,    23,
      24,    35,    20,    18,     5,     6,     7,    25,    26,    32,
      33,    29,    30,    31,    44,    40,    39,    46,    19,     0,
      41,    42,    45,    43,    47,     0,     0,     0,     0,    36
};

static const yytype_int8 yycheck[] =
{
       0,     1,     5,     3,     3,    10,     7,    12,     3,    11,
      12,    14,    13,     9,    14,    15,    16,     4,     5,     3,
       4,     4,    11,    11,    38,    11,     8,     4,     7,    -1,
      11,    11,     7,    11,     8,    -1,    -1,    -1,    -1,    24
};
...
{
       0,    19,     0,     1,     3,    14,    15,    16,    20,    21,
      22,    23,    26,    27,    28,    29,    30,    31,     9,     7,
      13,     3,     3,    11,    12,     4,     5,    24,    25,     4,
      11,    11,     3,     4,     5,    14,    31,    10,    12,     8,
      11,    11,    11,    11,    25,     7,     4,     8
};
...
#line 135 "src/parser.y"
    {
	     int length =getLength((yyvsp[(3) - (5)].list));
		printDebug("length: %d",length);
		printDebug("Function Call\nFunction name:%s\nCalled with %d arguments",(yyvsp[(1) - (5)].svalue),length);
		for(int i = 0 ; i<getLength((yyvsp[(3) - (5)].list)); i++){
			t_list *raw_elem = getElementAt((yyvsp[(3) - (5)].list),i);
			int elem = *((int*)(raw_elem->data));
			printDebug("Arg %d: %d\n",i,elem);
		}
		if(strcmp((yyvsp[(1) - (5)].svalue),"m")==0){
			if(length != 2){
				printf("Wrong number of arguments, function m takes 2 arguments\n> ");
			}else{
				t_list *raw_elem = getElementAt((yyvsp[(3) - (5)].list),0);
				int index_i = *((int*)(raw_elem->data));
				raw_elem = getElementAt((yyvsp[(3) - (5)].list),1);
				int index_j = *((int*)(raw_elem->data));
				int mv= m_v(index_i,index_j,pR->s,pR->p,pR->q);
				int mh= m_h(index_i,index_j,pR->s,pR->p,pR->q);
				printf("(%d,%d)\n> ",mv,mh);
			}
		}else if(strcmp((yyvsp[(1) - (5)].svalue),"AGU")==0){
			if(length != 3){
				...
				raw_elem = getElementAt((yyvsp[(3) - (5)].list),1);
				int index_j = *((int*)(raw_elem->data));
				raw_elem = getElementAt((yyvsp[(3) - (5)].list),2);
		...
		}else if(strcmp((yyvsp[(1) - (5)].svalue),"A_custom")==0){
			if(length != 5){
				...
				raw_elem = getElementAt((yyvsp[(3) - (5)].list),3);
				int beta = *((int*)(raw_elem->data));
				raw_elem = getElementAt((yyvsp[(3) - (5)].list),4);
				acc_type type = *((acc_type*)(raw_elem->data));
...
int res = A_custom(pR,index_i,index_j,alpha,beta,type);	
		...
		}else if(strcmp((yyvsp[(1) - (5)].svalue),"A_standard")==0){
			if(length != 2){
...
#line 210 "src/parser.y"
    {
	printDebug("Adding element %d to the given list\n",*((int*)(yyvsp[(3) - (3)].generic)));
		(yyval.list) = addElement((yyvsp[(1) - (3)].list),(yyvsp[(3) - (3)].generic),-1);
		int length = getLength((yyval.list));
		printDebug("List length: %d\n",length);
		for(int i =0; i<length;i++){
			t_list *raw_elem = getElementAt((yyval.list),i);
			int elem = *((int*)(raw_elem->data));
...
#line 222 "src/parser.y"
    {	printDebug("Creating a new arg_list and adding %d\n",*((int*)(yyvsp[(1) - (1)].generic)));
		(yyval.list) = addElement(NULL,(yyvsp[(1) - (1)].generic),-1);	
		t_list *retrived = getElementAt((yyval.list),0);
...
#line 243 "src/parser.y"
    {
		...
		if(strcmp((yyvsp[(2) - (4)].svalue),"s")==0){
			//ADD FREE old pR 
			pR->s = (yyvsp[(3) - (4)].intval);
			for(int i=0;i< N;i++)
				for(int j=0;j<M;j++){
...
#line 261 "src/parser.y"
    {
		...
		if(strcmp((yyvsp[(2) - (4)].svalue),"mode")==0){
			if(strcmp((yyvsp[(3) - (4)].svalue),"custom")==0){
				printf("PRF in custom mode\n");
				mode = CUSTOM;
			}else if(strcmp((yyvsp[(3) - (4)].svalue),"standard")==0){
...
#line 279 "src/parser.y"
    {
		printDebug("parsed show_instruction\n");
			if(strcmp((yyvsp[(2) - (3)].svalue),"s")==0){
				printf("s=%d\n",pR->s);
				}

if(strcmp((yyvsp[(2) - (3)].svalue),"matrix")==0){
				printMatrix(data_elements1,N,M);	
				}
			if(strcmp((yyvsp[(2) - (3)].svalue),"PRF")==0){
			  int **PrLayer;
			  for(int i=0;i<z;i++){
					printf("\n");
					printf("Layer %d\n",i);
...
if(strcmp((yyvsp[(2) - (3)].svalue),"mode")==0){
				switch(mode){
					case STANDARD:
							printf("PRF in standard mode\n");
							break;
...
#line 318 "src/parser.y"
    {
		...
		Address2d *access =(Address2d*) ((yyvsp[(1) - (4)].list)->data);
		printf("A[%d][%d],%d\n",access->i,access->j,(yyvsp[(3) - (4)].access_type));
		performBlockRead(access->i,access->j,(yyvsp[(3) - (4)].access_type),data_elements1,pR,mode);
		printf("> ");
...
#line 327 "src/parser.y"
    {
		...
		if(getLength((yyvsp[(1) - (2)].list))==1){
			printDebug("It is a single access \n");
			void *tmp = ((yyvsp[(1) - (2)].list))->data;
		...
		t_list *block_accesses = parallelAccessCoverage(pR,(yyvsp[(1) - (2)].list));
...
#line 361 "src/parser.y"
    {
	   ...
	   (yyval.list) = addElement((yyvsp[(1) - (3)].list),(yyvsp[(3) - (3)].access),-1);			
					;}
    break;
...
#line 366 "src/parser.y"
    {
		...
		t_list *access_list = addElement(NULL,(yyvsp[(1) - (1)].access),-1);
		(yyval.list) = access_list;
					;}
    break;
...
#line 372 "src/parser.y"
    {
      printDebug("Found access A[%d][%d]\n",(yyvsp[(3) - (7)].intval),(yyvsp[(6) - (7)].intval));
      Address2d *current_access= (Address2d*) malloc(sizeof(Address2d));
		current_access->i=(yyvsp[(3) - (7)].intval);
		current_access->j=(yyvsp[(6) - (7)].intval);
		(yyval.access) = current_access;
	;}
    break;
